...
public class MyFactory
{
    ...
    static
    {
        ...
        registerImplementation(MyFactory.FactoryKeys.RMI_SERVER, MyRmiServer.class.getName(), true);
        registerImplementation(MyFactory.FactoryKeys.RMI_CLIENT, MyRmiClient.class.getName(), true);
        registerImplementation(MyFactory.FactoryKeys.WEB_SOCKET_SERVER, MyWSServerBooter.class.getName(), true);
        registerImplementation(MyFactory.FactoryKeys.WEB_SOCKET_CLIENT, MyWSClientBooter.class.getName(), true);
    }
